...
clean_tnf_xref_basic = {
    ...
    "RTO_SEARCH": {"substring": ["-RTO", " -RTO", "- RTO"], "replace_with": " RTO"},
    "LIST_TRICLIMATE": {
        "substring": [
            "TRICLIMAT ",
            "TRICLIMA ",
    ...
    "LIST_HYBRID": {"substring": ["HYBD ", "HYBR "], "replace_with": "HYBRID "},
    ...
    "LIST_THERMOBALL": {
        "substring": ["THERMOBAL ", "THERMOBA ", "THERMOB ", "THMBALL "],
