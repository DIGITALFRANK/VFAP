...
zip -r refine-routine-$VERSION.zip .
...
aws s3 cp $CODEBUILD_SRC_DIR/refine-routine/src/refine-routine-$VERSION.zip s3://vf-artifacts-bucket/vfap/refine-routine/src/
