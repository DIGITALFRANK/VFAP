...
zip -r common-gluejob-trigger-V.1.0.0.zip .
...
aws s3 cp $CODEBUILD_SRC_DIR/glue-triggers/common-trigger/src/common-gluejob-trigger-V.1.0.0.zip s3://vf-artifacts-bucket/vfap/glue-triggers/common-trigger/src/
