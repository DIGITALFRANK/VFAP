...
class tr_adobe_attribution_weekly(Dataprocessor_Job):
    ...
    def transform(self, df):
        ...
        try:
            ...
            df_visitor = df_channel.withColumnRenamed("Weekly Unique Visitors",
            ...
            df_fiscal = df_null.join(fiscal_calender_df,
                ...
                df_null.Brand,
                df_null.Country,
                df_null.Weekly_Unique_Visitors,
                df_null.Weekly_Visits,
            ...
            full_load_df = None
            logger.info(
                "Error Occured While processing tr_adobe_attribution due to : {}".format(
                    error))
